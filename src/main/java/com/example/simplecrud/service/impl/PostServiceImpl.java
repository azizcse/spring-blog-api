...
import com.example.simplecrud.exception.BadRequestException;
...
import com.example.simplecrud.repository.PostRepository;
import com.example.simplecrud.repository.TagRepository;
import com.example.simplecrud.repository.UserRepository;
import com.example.simplecrud.security.UserPrincipal;
import com.example.simplecrud.service.PostService;
import com.example.simplecrud.utils.AppConstants;
...
import static com.example.simplecrud.utils.AppConstants.*;
...
public class PostServiceImpl implements PostService {
	...
	public PagedResponse<Post> getPostsByTag(Long id, int page, int size) {
		...
		Page<Post> posts = null;// postRepository.findByTags(Collections.singletonList(tag), pageable);
